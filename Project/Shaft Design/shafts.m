function [FOS,FOS_torsion,FOS_yield] = shafts(Sut,finish,d,loading,temp,reliability,Kt_bend,q_bend,Kt_axial,q_axial,Kts,qs,sigma_bending_max,sigma_bending_min,sigma_axial_max,sigma_axial_min,torque_max,torque_min,Sy)
...
sigm_prime = sigma_m_prime_func(Kfs,Kf_axial,sigma_m_bend,sigma_m_axial,Kfs,Tm);
[FOS,FOS_torsion]=modGoodman_fos_func(siga_prime,sigm_prime,Ta,Tm,Se,Sut)
