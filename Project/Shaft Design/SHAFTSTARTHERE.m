...
sigma_bending_max=0.1014;
sigma_bending_min=-0.1014;
...
% Yield Strength
Sy=1050;
[FOS,FOS_torsion,FOS_yield] = shafts(Sut,finish,d,loading,temp,reliability,Kt_bend,q_bend,Kt_axial,q_axial,Kts,qs,sigma_bending_max,sigma_bending_min,sigma_axial_max,sigma_axial_min,torque_max,torque_min,Sy);