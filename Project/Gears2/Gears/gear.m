function [BS,BS_FOS,CS,CS_FOS] = gear(d,N,H,F,RPM,Yn_lookup,tR,ht,power,machine,KvFactor,crown,gearcond,Ce_accomidation,J_lookup,gearmaterial,pinionmaterial,Nitrided,N_cyc,reli,Hb,Grade,pinion,Hp,Hg,mg,angle,inout,St_lookup)%,LF)
